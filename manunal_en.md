...
## Select specified file to destination path after reading CMF file.

- This Yuri ver can Select specifieds file to destination path after reading CMF file.

- Select one more specified files.
